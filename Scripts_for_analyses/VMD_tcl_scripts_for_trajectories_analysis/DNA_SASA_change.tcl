foreach input  {ModelA ModelB ModelC ModelD} {
...
set outfile0 [open rsasa_all_${input}.dat a]
set outfile1 [open dsasa_all_${input}.dat a]	
set outfile2 [open dsasa_H3_${input}.dat a]
set outfile3 [open dsasa_H4_${input}.dat a]
set outfile4 [open dsasa_H2A_${input}.dat a]
set outfile5 [open dsasa_H2B_${input}.dat a]
