...
set outfile11 [open tail_DNA_mean_contacts_all_${name}_h3_A.dat w]
set outfile12 [open tail_DNA_mean_contacts_all_${name}_h3_E.dat w]
set outfile13 [open tail_DNA_mean_contacts_backbone_${name}_h3_A.dat w]
set outfile14 [open tail_DNA_mean_contacts_backbone_${name}_h3_E.dat w]
set outfile15 [open tail_DNA_mean_contacts_base_${name}_h3_A.dat w]
set outfile16 [open tail_DNA_mean_contacts_base_${name}_h3_E.dat w]

set outfile21 [open tail_DNA_mean_contacts_all_${name}_h4_B.dat w]
set outfile22 [open tail_DNA_mean_contacts_all_${name}_h4_F.dat w]
set outfile23 [open tail_DNA_mean_contacts_backbone_${name}_h4_B.dat w]
set outfile24 [open tail_DNA_mean_contacts_backbone_${name}_h4_F.dat w]
set outfile25 [open tail_DNA_mean_contacts_base_${name}_h4_B.dat w]
set outfile26 [open tail_DNA_mean_contacts_base_${name}_h4_F.dat w]

set outfile31 [open tail_DNA_mean_contacts_all_${name}_h2a_C.dat w]
set outfile32 [open tail_DNA_mean_contacts_all_${name}_h2a_G.dat w]
set outfile33 [open tail_DNA_mean_contacts_backbone_${name}_h2a_C.dat w]
set outfile34 [open tail_DNA_mean_contacts_backbone_${name}_h2a_G.dat w]
set outfile35 [open tail_DNA_mean_contacts_base_${name}_h2a_C.dat w]
set outfile36 [open tail_DNA_mean_contacts_base_${name}_h2a_G.dat w]

set outfile41 [open tail_DNA_mean_contacts_all_${name}_h2b_D.dat w]
set outfile42 [open tail_DNA_mean_contacts_all_${name}_h2b_H.dat w]
set outfile43 [open tail_DNA_mean_contacts_backbone_${name}_h2b_D.dat w]
set outfile44 [open tail_DNA_mean_contacts_backbone_${name}_h2b_H.dat w]
set outfile45 [open tail_DNA_mean_contacts_base_${name}_h2b_D.dat w]
set outfile46 [open tail_DNA_mean_contacts_base_${name}_h2b_H.dat w]
