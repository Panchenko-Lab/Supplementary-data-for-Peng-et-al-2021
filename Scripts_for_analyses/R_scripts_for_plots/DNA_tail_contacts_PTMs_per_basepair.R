...
library(matrixStats)
df11<-read.table(paste("dna_tail_mean_contacts_modelD_h2a.dat",sep=""),header=TRUE)
df12<-read.table(paste("dna_tail_mean_contacts_modelD_h2b.dat",sep=""),header=TRUE)
df13<-read.table(paste("dna_tail_mean_contacts_modelD_h3.dat",sep=""),header=TRUE)
df14<-read.table(paste("dna_tail_mean_contacts_modelD_h4.dat",sep=""),header=TRUE)

df21<-read.table(paste("dna_prot_contacts_ARG_ala_h2a.dat",sep=""),header=TRUE)
df22<-read.table(paste("dna_prot_contacts_ARG_ala_h2b.dat",sep=""),header=TRUE)
df23<-read.table(paste("dna_prot_contacts_ARG_ala_h3.dat",sep=""),header=TRUE)
df24<-read.table(paste("dna_prot_contacts_ARG_ala_h4.dat",sep=""),header=TRUE)

df31<-read.table(paste("dna_prot_contacts_LYS_Ac_h2a.dat",sep=""),header=TRUE)
df32<-read.table(paste("dna_prot_contacts_LYS_Ac_h2b.dat",sep=""),header=TRUE)
df33<-read.table(paste("dna_prot_contacts_LYS_Ac_h3.dat",sep=""),header=TRUE)
df34<-read.table(paste("dna_prot_contacts_LYS_Ac_h4.dat",sep=""),header=TRUE)

df41<-read.table(paste("dna_prot_contacts_LYS_Me_h2a.dat",sep=""),header=TRUE)
df42<-read.table(paste("dna_prot_contacts_LYS_Me_h2b.dat",sep=""),header=TRUE)
df43<-read.table(paste("dna_prot_contacts_LYS_Me_h3.dat",sep=""),header=TRUE)
df44<-read.table(paste("dna_prot_contacts_LYS_Me_h4.dat",sep=""),header=TRUE)

df51<-read.table(paste("dna_prot_contacts_SER_ph_h2a.dat",sep=""),header=TRUE)
df52<-read.table(paste("dna_prot_contacts_SER_ph_h2b.dat",sep=""),header=TRUE)
df53<-read.table(paste("dna_prot_contacts_SER_ph_h3.dat",sep=""),header=TRUE)
df54<-read.table(paste("dna_prot_contacts_SER_ph_h4.dat",sep=""),header=TRUE)

df61<-read.table(paste("dna_prot_contacts_select_h2a.dat",sep=""),header=TRUE)
df62<-read.table(paste("dna_prot_contacts_select_h2b.dat",sep=""),header=TRUE)
df63<-read.table(paste("dna_prot_contacts_select_h3.dat",sep=""),header=TRUE)
df64<-read.table(paste("dna_prot_contacts_select_h4.dat",sep=""),header=TRUE)
...
## calculate means from each independent run
#h2a
