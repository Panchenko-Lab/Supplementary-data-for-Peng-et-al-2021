...
tail2 = "h2B_H"
cut_off = 0.1
png(file=paste("./amber/residence_time_4500ns/time_binary/tail_contacts_time_",tail,"_",cut_off,".png",sep=""),width=12,height=15,units="in",res=300)
...
png(file=paste("./amber/residence_time_4500ns/time_binary/Representative_tail_contacts_time_",tail,"_",cut_off,".png",sep=""),width=20,height=5,units="in",res=300)
plot(seq(200,4000,0.2),  ratio42 , type="l" , bty="l" , xlab="" , ylab="" , #yaxt="n",
     col="red" , lwd=1 , pch=15 , ylim=c(0,1) , cex.lab=2.5,cex.axis=2.5,font=2)
#lines(seq(200,2450,0.2), ratio41 , col="blue" , lwd=1 , pch=16 , type="l" )
abline(h=0.1,lty="dashed", lwd=3)
#mtext(side=1, line=2, "Time(ns)", col="black", font=2,cex=1.2,padj = 1)
#mtext(side=2, line=3, "", col="black", font=2, cex=1.2)
