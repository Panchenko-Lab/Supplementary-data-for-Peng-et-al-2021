...
library(matrixStats)
file = ""
png(file=paste("./amber/sasa_4500ns/sasa_all_compare_half_",file,".png",sep=""),width=8,height=6,units="in",res=300)
df11<-read.table(paste("./amber/sasa_4500ns/dsasa_H2A",file,"_1aoi.dat",sep=""),header=TRUE)
df12<-read.table(paste("./amber/sasa_4500ns/dsasa_H2A",file,"_1eqz.dat",sep=""),header=TRUE)
df13<-read.table(paste("./amber/sasa_4500ns/dsasa_H2A",file,"_ext2.dat",sep=""),header=TRUE)
df14<-read.table(paste("./amber/sasa_4500ns/dsasa_H2A",file,"_sym.dat",sep=""),header=TRUE)
df15<-read.table(paste("./amber/sasa_4500ns/dsasa_H2A",file,"_shuxiang_ext_sym_amber_run1.dat",sep=""),header=TRUE)
df16<-read.table(paste("./amber/sasa_4500ns/dsasa_H2A",file,"_shuxiang_ext_sym_amber_run2.dat",sep=""),header=TRUE)

df21<-read.table(paste("./amber/sasa_4500ns/dsasa_H2B",file,"_1aoi.dat",sep=""),header=TRUE)
df22<-read.table(paste("./amber/sasa_4500ns/dsasa_H2B",file,"_1eqz.dat",sep=""),header=TRUE)
df23<-read.table(paste("./amber/sasa_4500ns/dsasa_H2B",file,"_ext2.dat",sep=""),header=TRUE)
df24<-read.table(paste("./amber/sasa_4500ns/dsasa_H2B",file,"_sym.dat",sep=""),header=TRUE)
df25<-read.table(paste("./amber/sasa_4500ns/dsasa_H2B",file,"_shuxiang_ext_sym_amber_run1.dat",sep=""),header=TRUE)
df26<-read.table(paste("./amber/sasa_4500ns/dsasa_H2B",file,"_shuxiang_ext_sym_amber_run2.dat",sep=""),header=TRUE)

df31<-read.table(paste("./amber/sasa_4500ns/dsasa_H3",file,"_1aoi.dat",sep=""),header=TRUE)
df32<-read.table(paste("./amber/sasa_4500ns/dsasa_H3",file,"_1eqz.dat",sep=""),header=TRUE)
df33<-read.table(paste("./amber/sasa_4500ns/dsasa_H3",file,"_ext2.dat",sep=""),header=TRUE)
df34<-read.table(paste("./amber/sasa_4500ns/dsasa_H3",file,"_sym.dat",sep=""),header=TRUE)
df35<-read.table(paste("./amber/sasa_4500ns/dsasa_H3",file,"_shuxiang_ext_sym_amber_run1.dat",sep=""),header=TRUE)
df36<-read.table(paste("./amber/sasa_4500ns/dsasa_H3",file,"_shuxiang_ext_sym_amber_run2.dat",sep=""),header=TRUE)

df41<-read.table(paste("./amber/sasa_4500ns/dsasa_H4",file,"_1aoi.dat",sep=""),header=TRUE)
df42<-read.table(paste("./amber/sasa_4500ns/dsasa_H4",file,"_1eqz.dat",sep=""),header=TRUE)
df43<-read.table(paste("./amber/sasa_4500ns/dsasa_H4",file,"_ext2.dat",sep=""),header=TRUE)
df44<-read.table(paste("./amber/sasa_4500ns/dsasa_H4",file,"_sym.dat",sep=""),header=TRUE)
df45<-read.table(paste("./amber/sasa_4500ns/dsasa_H4",file,"_shuxiang_ext_sym_amber_run1.dat",sep=""),header=TRUE)
df46<-read.table(paste("./amber/sasa_4500ns/dsasa_H4",file,"_shuxiang_ext_sym_amber_run2.dat",sep=""),header=TRUE)

dfall1<-read.table("./amber/sasa_4500ns/dsasa_all_1aoi.dat",header=TRUE)
dfall2<-read.table("./amber/sasa_4500ns/dsasa_all_1eqz.dat",header=TRUE)
dfall3<-read.table("./amber/sasa_4500ns/dsasa_all_ext2.dat",header=TRUE)
dfall4<-read.table("./amber/sasa_4500ns/dsasa_all_sym.dat",header=TRUE)
dfall5<-read.table("./amber/sasa_4500ns/dsasa_all_shuxiang_ext_sym_amber_run1.dat",header=TRUE)
dfall6<-read.table("./amber/sasa_4500ns/dsasa_all_shuxiang_ext_sym_amber_run2.dat",header=TRUE)
...
dfall1<-as.matrix(dfall1[,-1])
dfall2<-as.matrix(dfall2[,-1])
dfall3<-as.matrix(dfall3[,-1])
dfall4<-as.matrix(dfall4[,-1])
dfall5<-as.matrix(dfall5[,-1])
dfall6<-as.matrix(dfall6[,-1])
...
#df1 <- df1[seq(1, nrow(df1), 2), ] ## 1ns interval of frames
#df2 <- df2[seq(1, nrow(df2), 2), ]
#df3 <- df3[seq(1, nrow(df3), 2), ]
#df4 <- df4[seq(1, nrow(df4), 2), ]
...
#meanall<-colMeans(dfall_half)*-1
#se_all<-colSds(dfall_half)/sqrt(length(dfall_half))*-1
...
#plot(seq(0,93,1),meanall , type="l" , bty="l" ,pch=18, xlab="Nucleosomal DNA position (SHL)" , ylab="Decrease of SASA" , 
#      col="blue" , lwd=2  , ylim=c(-120,0) ,xaxt = "none",yaxt = "none", axis.lty=1, font.axis=2,font.lab=2,
#      cex.lab=1.6,cex.axis=1.1)
#abline(v = seq(-73.5, 73.5, by = 10.5),lty=2, col="grey",lwd=2)

#barx <- barplot(meanall, beside=FALSE, 
...
#                xlab="Nucleosomal DNA position (SHL)" , ylab="Decrease of DNA accessibility", xaxt = "none",ylim = c(-90,0))
#arrows(seq(0,93,1), meanall-se_all/2, seq(0,93,1), meanall+se_all/2, length=0.02, angle=90, code=3, col="blue")
...
dsasa_mean=mean1 + mean2 + mean3 +mean4
write.csv(dsasa_mean,"./amber/sasa_4500ns/dsasa_mean.csv", row.names = FALSE)