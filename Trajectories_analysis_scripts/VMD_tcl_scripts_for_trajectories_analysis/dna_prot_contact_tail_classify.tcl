...
mol addfile ../${name}_rw_run1_2500ns.nc first 2500 125000 step 10 waitfor all
mol addfile ../${name}_rw_run2_200ns.nc first 2500 10000 step 10 waitfor all
mol addfile ../${name}_rw_run3_200ns.nc first 2500 10000 step 10 waitfor all
mol addfile ../${name}_rw_run4_200ns.nc first 2500 10000 step 10 waitfor all
mol addfile ../${name}_rw_run5_200ns.nc first 2500 10000 step 10 waitfor all
