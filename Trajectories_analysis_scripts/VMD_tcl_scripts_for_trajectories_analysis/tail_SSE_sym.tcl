...
mol addfile ../${name}_rw_run1_4000ns.nc first 10000 last 200000 step 10 waitfor all
...
set outfile1 [open ./SSE/tail_SSE_${name}_h3_A.dat w]
set outfile2 [open ./SSE/tail_SSE_${name}_h3_E.dat w]
set outfile3 [open ./SSE/tail_SSE_${name}_h4_B.dat w]
set outfile4 [open ./SSE/tail_SSE_${name}_h4_F.dat w]
set outfile5 [open ./SSE/tail_SSE_${name}_h2a_C.dat w]
set outfile6 [open ./SSE/tail_SSE_${name}_h2a_G.dat w]
set outfile7 [open ./SSE/tail_SSE_${name}_h2b_D.dat w]
set outfile8 [open ./SSE/tail_SSE_${name}_h2b_H.dat w]
