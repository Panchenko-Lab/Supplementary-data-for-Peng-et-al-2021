...
set sel [atomselect top "resid 503 to 624 "]
$sel set chain D
$sel set segname CHD
renumber $sel 1
$sel delete
...
set sel [atomselect top "resid 625 to 759 "]
$sel set chain E
$sel set segname CHE
renumber $sel 1
$sel delete

set sel [atomselect top "resid 760 to 861 "]
$sel set chain F
$sel set segname CHF
renumber $sel 1
$sel delete
...
set sel [atomselect top "resid 984 to 1118 "]
$sel set chain A
$sel set segname CHA
renumber $sel 1
$sel delete
...
set sel [atomselect top "resid 1119 to 1220 "]
$sel set chain B
$sel set segname CHB
renumber $sel 1
$sel delete
