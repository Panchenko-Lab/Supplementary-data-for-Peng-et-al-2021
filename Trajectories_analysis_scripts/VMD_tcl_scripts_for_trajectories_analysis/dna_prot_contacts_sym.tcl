...
set outfile0 [open ./DNA_contacts/dna_prot_contacts_${name}_all.dat a]
set outfile1 [open ./DNA_contacts/dna_prot_contacts_${name}_h3.dat a]
set outfile2 [open ./DNA_contacts/dna_prot_contacts_${name}_h4.dat a]
set outfile3 [open ./DNA_contacts/dna_prot_contacts_${name}_h2a.dat a]
set outfile4 [open ./DNA_contacts/dna_prot_contacts_${name}_h2b.dat a]
